...
export default function Footer() {
  return (
    <footer className="bg-[#111c11] text-white pt-12 sm:pt-16 md:pt-24 pb-8 sm:pb-10 md:pb-12 border-t border-white/5 relative overflow-hidden">
      <div className="container mx-auto px-4">
        {/* Top Layout */}
        <div className="grid gap-8 sm:gap-10 md:gap-12 lg:grid-cols-[1.2fr_1.8fr] pb-10 sm:pb-12 md:pb-16 border-b border-white/10">
            ...
            <div className="flex gap-2.5 sm:gap-3">
              {[
                ...
                <a
                  ...
                  className="w-9 h-9 sm:w-10 sm:h-10 rounded-xl border border-white/20 flex items-center justify-center text-white/80 hover:bg-white hover:text-[#111c11] hover:border-white transition-all duration-300"
                >
        ...
        <div className="pt-8 sm:pt-10 md:pt-12 flex flex-col items-center">
          {/* Massive footer signature text like Contelas mockup */}
          <div className="w-full text-center select-none overflow-hidden h-12 sm:h-16 md:h-20 lg:h-24 flex items-center justify-center">
            <h1 className="text-3xl sm:text-5xl md:text-6xl lg:text-7xl xl:text-8xl font-bold text-safe-accent/15 tracking-tighter leading-none uppercase whitespace-nowrap">
              SAFE INVESTMENT
            </h1>
          </div>

          <div className="w-full flex flex-col sm:flex-row justify-between items-center gap-3 sm:gap-4 text-xs text-white/30 tracking-wider border-t border-white/5 pt-6 sm:pt-8">
