  ...
  return (
    <main className="min-h-screen flex flex-col bg-[#f7f8f3] text-[#233123]">
      ...
      <section className="relative min-h-screen w-full overflow-hidden">
        ...
        <div className="relative z-10 container mx-auto flex min-h-screen items-center px-4 pt-36">
          <FadeInUp className="max-w-3xl text-white">
            <span className="mb-6 inline-flex rounded-full border border-white/30 bg-white/10 px-5 py-2 text-xs font-bold uppercase tracking-[0.35em] backdrop-blur">
              Tanga, Tanzania
            </span>
            <h1 className="mt-6 text-3xl font-semibold leading-[1.1] md:text-5xl lg:text-6xl tracking-tight">
            ...
            <div className="mt-10 flex flex-col gap-4 sm:flex-row">
              <a
                href="#rashid-heights"
                className="rounded-full bg-safe-accent px-8 py-4 text-center text-sm font-bold uppercase tracking-widest text-white transition hover:bg-safe-accent/90"
              >
              ...
              <a
                ...
                className="rounded-full border border-white/40 px-8 py-4 text-center text-sm font-bold uppercase tracking-widest text-white transition hover:bg-white hover:text-safe-primary"
              >
      ...
      <section id="about" className="bg-white py-24">
        <div className="container mx-auto grid gap-12 px-4 md:grid-cols-[0.9fr_1.1fr] md:items-end">
          <FadeInUp>
            <span className="text-xs font-bold uppercase tracking-[0.3em] text-safe-accent">
              Safe Investment
            </span>
            <h2 className="mt-4 text-4xl font-semibold leading-tight text-safe-primary md:text-5xl">
              Property expertise rooted in Tanga.
            </h2>
          </FadeInUp>
          <FadeInUp delay={0.15} className="space-y-6 text-lg leading-8 text-[#536153]">
            <p>
      ...
      <section id="services" className="py-24">
        <div className="container mx-auto px-4">
          <FadeInUp className="mb-12 max-w-2xl">
            ...
            <h2 className="mt-4 text-4xl font-semibold text-safe-primary md:text-5xl">
          ...
          <div className="grid gap-4 md:grid-cols-3">
            {services.map((service, i) => (
              <FadeInUp key={service.name} delay={i * 0.07}>
                <div className="rounded-3xl border border-safe-primary/10 bg-white p-8 shadow-sm transition hover:-translate-y-1 hover:shadow-xl h-full">
                  <i className={`${service.icon} text-3xl text-safe-accent`} />
                  <h3 className="mt-4 text-xl font-semibold text-safe-primary">
                    {service.name}
                  </h3>
      ...
      <section id="rashid-heights" className="bg-safe-primary text-white">
        ...
        <div className="py-24">
          <div className="container mx-auto grid gap-12 px-4 lg:grid-cols-2 lg:items-center">
            <FadeInUp className="relative min-h-[580px] overflow-hidden rounded-[2rem]">
              <Image
                src="/img/build1.png"
              ...
              <div className="absolute bottom-8 left-8 right-8 rounded-3xl bg-white/10 p-6 backdrop-blur">
                <p className="text-xs font-bold uppercase tracking-[0.3em] text-white/70">
                  Now rising
                </p>
                <h3 className="mt-2 text-3xl font-semibold">Rashid Heights</h3>
              </div>
            </FadeInUp>
            <FadeInUp delay={0.15}>
              ...
              <a
                href="#contact"
                className="mt-10 inline-flex items-center gap-2 rounded-full bg-white px-8 py-4 text-sm font-bold uppercase tracking-widest text-safe-primary transition hover:bg-white/85"
              >
        ...
        <div className="border-t border-white/10 pb-24">
          <div className="container mx-auto px-4">
            <FadeInUp className="pt-16 mb-10">
                ...
                <FadeInUp key={unit.label} delay={i * 0.1}>
                  <div className="rounded-2xl overflow-hidden bg-white/5 border border-white/10 h-full flex flex-col">
                    ...
                    <div className="p-5 flex flex-col flex-1">
                      <i className={`${unit.icon} text-2xl text-safe-accent`} />
                      <h4 className="mt-2 font-semibold text-base">
                        {unit.label}
                      </h4>
                      <p className="mt-2 text-sm text-white/60 leading-6 flex-1">
                        {unit.desc}
                      </p>
                    </div>
                  </div>
      ...
      <section id="contact" className="bg-white py-24">
        <div className="container mx-auto grid gap-12 px-4 lg:grid-cols-[0.85fr_1.15fr] lg:items-start">
          <FadeInUp>
            ...
            <p className="mt-6 text-lg leading-8 text-[#536153]">
            ...
            <div className="mt-8 flex flex-col gap-3">
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="inline-flex items-center gap-2 rounded-full bg-safe-accent px-8 py-4 text-sm font-bold uppercase tracking-widest text-white transition hover:bg-safe-accent/90 w-fit"
              >
              ...
              <a
                ...
                className="inline-flex items-center gap-2 text-safe-primary hover:text-safe-accent transition text-sm mt-2"
              >
                <i className="ri-phone-line" /> +255 746 373 71
              </a>
              <a
                href="mailto:sales@safeinvestment.co.tz"
                className="inline-flex items-center gap-2 text-safe-primary hover:text-safe-accent transition text-sm"
              >
          ...
          <FadeInUp delay={0.15}>
            <form
              ...
              method="POST"
              className="rounded-[2rem] bg-[#f7f8f3] p-6 shadow-sm md:p-10"
            >
              <div className="space-y-6">
                <div className="space-y-2">
                  ...
                  <input
                    ...
                    name="name"
                    required
                    className="w-full rounded-2xl border border-safe-primary/10 bg-white px-5 py-4 outline-none transition focus:border-safe-accent"
              ...
              <div className="mt-6 space-y-2">
                ...
                <textarea
                  ...
                  rows={7}
                  required
                  className="w-full resize-none rounded-2xl border border-safe-primary/10 bg-white px-5 py-4 outline-none transition focus:border-safe-accent"
                  placeholder="Tell us what you are looking for..."
                />
              </div>
              <button
                type="submit"
                className="mt-8 rounded-full bg-safe-primary px-8 py-4 text-sm font-bold uppercase tracking-widest text-white transition hover:bg-safe-primary/90"
              >
                Send enquiry
              </button>
            </form>
